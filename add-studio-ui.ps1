...
Write-File "frontend\pages\studio.html" @'
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
Write-File "frontend\pages\studio.css" @'
* {
...
Write-File "frontend\pages\studio.js" @'
...
generateBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    summaryBox.innerHTML = `
      ...
      <strong>Export:</strong> D:\\APPS\\IdeasForgeAI\\generated-apps\\${(data.project_name || "generated-product").toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "")}
    `;
...
Write-Host ""
Write-Host "IdeasForgeAI Studio UI added successfully." -ForegroundColor Green
Write-Host ""
Write-Host "Open:"
Write-Host "D:\APPS\IdeasForgeAI\frontend\pages\studio.html"
'@