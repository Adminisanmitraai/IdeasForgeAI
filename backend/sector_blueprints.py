...
SECTOR_BLUEPRINTS: Dict[str, Dict[str, Any]] = {
    ...
    "school_teacher_parent": {
        ...
        "app_name_style": "Teacher-parent communication and student progress app",
        "theme_intent": "education-soft-blue",
        "primary_users": ["Teacher", "Parent", "School admin"],
        "must_have_screens": ["dashboard", "students", "attendance", "homework", "messages"],
        "suggested_screens": ["progress_report", "events", "fees", "timetable"],
        "dashboard_cards": ["Attendance", "Homework due", "Parent messages", "Class notices"],
        "primary_actions": ["Mark attendance", "Assign homework", "Message parent", "Add notice"],
        "clickable_aliases": ["student", "attendance", "homework", "parent", "message"],
        "domain_terms": ["student", "class", "attendance", "homework", "parent", "notice"],
        "forbidden_generic_terms": ["policy premium", "mandi", "table booking"],
        "sample_records": ["Class 5 attendance", "Math homework", "Parent meeting"],
        "empty_state_guidance": "Ask the teacher to add class, students, and parent contact list.",
        "trust_and_safety_notes": ["Protect student data.", "Avoid exposing sensitive child information."],
        "monetization_suggestions": ["School SaaS subscription", "Parent communication module"],
