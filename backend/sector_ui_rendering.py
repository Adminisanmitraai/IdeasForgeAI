...
SECTOR_UI_PROFILES: Dict[str, Dict[str, Any]] = {
    ...
    "school_teacher_parent": {
        "hero_kicker": "Tutor classroom bridge",
        "hero_visual_title": "Tutor class manager",
        "visual_mood": "soft, clear, tutor and student-safe",
        "dashboard_card_style": "metric-soft",
        "sample_component_labels": ["Students", "Classes", "Fees"],
    ...
    "wedding_event_lawn": {
        ...
        "action_badge": "Venue action",
        "action_descriptions": {
            "Book Date": "Reserve available venue date and time slot.",
            "Create Event": "Create wedding, engagement, haldi, or mehendi event.",
            "Select Package": "Choose lawn, decor, catering, and stage package.",
            "Assign Vendor": "Assign decorator, caterer, photographer, or event team.",
            "Collect Advance": "Track advance payment, balance, and confirmation.",
        },
