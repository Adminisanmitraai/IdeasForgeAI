...
PHASE_REGISTRY: Dict[str, Dict[str, object]] = {
    ...
    "CA-31": {
        ...
        "implemented": True,
        "required_endpoints": [
            ("GET", "/api/coding-agent/test-runner/health"),
            ("POST", "/api/coding-agent/test-runner/validate"),
            ("POST", "/api/coding-agent/test-runner/run"),
            ("GET", "/api/coding-agent/run-tests/health"),
            ("POST", "/api/coding-agent/run-tests"),
        ],
    ...
    "CA-34": {
        ...
        "required_endpoints": [
            ...
            ("POST", "/api/coding-agent/deployment/preview"),
            ("POST", "/api/coding-agent/deployment/request-approval"),
            ("GET", "/api/coding-agent/render-flow/health"),
            ("POST", "/api/coding-agent/render-flow/preview"),
        ],
        "required_frontend_terms": ["Deployment Manager"],
        "required_backend_terms": [
            "DeploymentApprovalRenderFlow",
            "deployment-render-flow",
            "deployment_flow_enabled",
            "render_service_name",
            "deploy_plan",
            "approval_gate",
            "render_api_write",
    ...
    "CA-35": {
        ...
        "implemented": True,
        "required_endpoints": [
            ("GET", "/api/coding-agent/rollback/health"),
            ("POST", "/api/coding-agent/rollback/plan"),
            ("POST", "/api/coding-agent/rollback/request-approval"),
        ],
    ...
    "CA-36": {
        ...
        "implemented": True,
        "required_endpoints": [
            ("GET", "/api/coding-agent/project-memory/health"),
            ("POST", "/api/coding-agent/project-memory/record"),
            ("POST", "/api/coding-agent/project-memory/history"),
            ("GET", "/api/coding-agent/memory/health"),
            ("POST", "/api/coding-agent/memory/record"),
            ("POST", "/api/coding-agent/memory/history"),
        ],
        "required_frontend_terms": ["Active Tasks"],
        "required_backend_terms": [
    ...
    "CA-37": {
        ...
        "implemented": True,
        "required_endpoints": [
            ("GET", "/api/coding-agent/founder-dashboard/health"),
            ("POST", "/api/coding-agent/founder-dashboard/summary"),
            ("POST", "/api/coding-agent/founder-dashboard/approval-queue"),
            ("POST", "/api/coding-agent/founder-dashboard/phase-control"),
            ("GET", "/api/coding-agent/admin-dashboard/health"),
            ("POST", "/api/coding-agent/admin-dashboard/summary"),
        ],
        "required_frontend_terms": ["Founder/Admin"],
        "required_backend_terms": [
    ...
    "CA-38": {
        ...
        "implemented": True,
        "required_endpoints": [
            ("GET", "/api/coding-agent/security-freeze/health"),
            ("POST", "/api/coding-agent/security-freeze/audit"),
            ("POST", "/api/coding-agent/security-freeze/freeze-check"),
            ("GET", "/api/coding-agent/production-freeze/health"),
            ("POST", "/api/coding-agent/production-freeze/audit"),
        ],
        "required_frontend_terms": ["Security"],
        "required_backend_terms": [
            "FullSecurityAuditProductionFreeze",
            "security-freeze",
            "production-freeze",
            "coding_agent_freeze_ready",
