...
REGIONS = {
    "status_header": (0.00, 0.00, 1.00, 0.155),
    "top_nav": (0.00, 0.075, 1.00, 0.175),
    "hero": (0.04, 0.175, 0.96, 0.365),
    "cards": (0.04, 0.365, 0.96, 0.755),
    "composer": (0.04, 0.755, 0.96, 0.865),
    "browser_safe_area": (0.04, 0.865, 0.96, 0.975),
}
...
def main() -> int:
    ...
    report = {
        ...
        "next_step": "Use low-scoring regions to generate exact repair instructions.",
    }
