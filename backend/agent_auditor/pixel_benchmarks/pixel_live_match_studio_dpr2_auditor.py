...
REGIONS = {
    "status_header": (0.00, 0.000, 1.00, 0.070),
    "top_nav": (0.00, 0.055, 1.00, 0.160),
    "hero": (0.00, 0.195, 1.00, 0.350),
    "cards": (0.00, 0.330, 1.00, 0.800),
    "composer": (0.00, 0.790, 1.00, 0.895),
    "browser_safe_area": (0.00, 0.895, 1.00, 1.00),
}
...
def main() -> int:
    ...
    report = {
        ...
        "phase": "PIXEL-MAP-PERFECT-18S-DPR2-REGION-RECALIBRATION",
        "created_at": stamp,
