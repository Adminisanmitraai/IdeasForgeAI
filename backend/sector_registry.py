...
SECTOR_REGISTRY: Dict[str, SectorEntry] = {
    ...
    "school_teacher_parent": _sector(
        ...
        ["school", "teacher", "student", "homework", "attendance", "exam marks", "parent messages", "timetable", "notices"],
        ["fees", "class", "parent", "education", "marks", "report card"],
        ["clinic", "insurance", "mutual fund"],
        70,
        "education-soft-blue",
        "card-first-dashboard",
        ["School Parent Connect", "Teacher Parent Portal", "Classroom Notice Hub"],
        "school parent communication and attendance app",
        ["school admins", "teachers", "parents", "students"],
        ["attendance tracking", "homework updates", "fee status", "parent notices", "teacher remarks", "student records", "class dashboard"],
        ["Home", "Parent Portal", "Attendance", "Homework", "Fees", "Parent Notices", "Exam Results", "Teacher Contact", "Admin Dashboard"],
        {"dashboard": "dashboard", "parent_portal": "parent_portal", "attendance": "attendance", "homework": "homework", "fees": "fees", "notices": "parent_notices", "parent_notices": "parent_notices", "exam_results": "exam_results", "teacher_contact": "teacher_contact", "admin": "admin_dashboard"},
        [["Attendance", "92%"], ["Homework", "3 due"], ["Notices", "5"]],
        [["Class 5A", "PTM Saturday"], ["Math", "Due tomorrow"], ["Science", "Submitted"]],
        "USD",
