...
Phase 21C validates explicit human approval before the final Phase 20 polished frontend can move toward replacing the protected main preview.

This phase is approval-gate only.
...
- replacement_dry_run_required = true
- replacement_manifest_required = true

## Phase 21C Safety Confirmation
